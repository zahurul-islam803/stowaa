                        ...
                        <div class="tab-pane fade show active" id="signin_tab" role="tabpanel">
                            <form action="{{ url('/customer/login') }}" method="POST">
                                ...
                                <div class="form_item_wrap">
                                    ...
                                    <div>
                                        <a href="{{ url('/github/redirect') }}" class="btn btn_primary px-4 my-1">Login With
                                            Github</a></br>
                                        <a href="{{ url('/google/redirect') }}" class="btn btn_primary px-4 my-1">Login With
                                            Google</a></br>
                                        <a href="{{ url('/facebook/redirect') }}"
                                            class="btn facebook-button px-4 my-1">Login
                                            With
                                            Facebook</a>
                                    </div>
