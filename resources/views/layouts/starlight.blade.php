...
<head>
    ...
    <title>Stowaa- @yield('title')</title>
...
<body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{ route('welcome') }}"><i class="icon ion-android-star-outline"></i>
            starlight</a>
    </div>
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('category') }}" class="nav-link @yield('category')">Add
                        Category</a>
                </li>
            </ul>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('subcategory') }}" class="nav-link @yield('subcategory')">Add
                        SubCategory</a>
                </li>
            </ul>
            <a href="#" class="sl-menu-link @yield('color.size')">
                <div class="sl-menu-item">
                    <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
                    <span class="menu-item-label">Color And Size</span>
                    <i class="menu-item-arrow fa fa-angle-down"></i>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('color.size') }}" class="nav-link @yield('color.size')">Add
                        Color And Size</a>
                </li>
            </ul>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('add.product') }}" class="nav-link @yield('product')">Add
                        Products</a>
                </li>
            </ul>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('role') }}" class="nav-link @yield('role')">Role
                        Manager</a>
                </li>
            </ul>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('coupon') }}" class="nav-link @yield('coupon')">Add
                        Coupon</a>
                </li>
            </ul>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('order') }}" class="nav-link @yield('order')">Order
                        List</a>
                </li>
            </ul>
                    ...
                    <a href="" class="media-list-link">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="tx-13 mg-t-10 mg-b-0">A wonderful serenity has taken possession of my
                                    entire
                    ...
                    <a href="" class="media-list-link">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="tx-13 mg-t-10 mg-b-0">My entire soul, like these sweet mornings of
                                    spring.
                                </p>
                            </div>
                        </div><!-- media -->
                    ...
                    <a href="" class="media-list-link">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="tx-13 mg-t-10 mg-b-0">I should be incapable of drawing a single stroke
                                    at the
                                    present moment...</p>
                            </div>
                        </div><!-- media -->
                    ...
                    <a href="" class="media-list-link">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="tx-13 mg-t-10 mg-b-0">When, while the lovely valley teems with vapour
                                    around
                ...
                <div class="media-list">
                    ...
                    <a href="" class="media-list-link read">
                        <div class="media pd-x-20 pd-y-15">
                            <img src="../img/img10.jpg" class="wd-40 rounded-circle" alt="">
                            <div class="media-body">
                                <p class="tx-13 mg-b-0 tx-gray-700">10+ new items added are for sale in your
                                    <strong class="tx-medium tx-gray-800">Sale Group</strong>
                                </p>
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            <a class="breadcrumb-item" href="{{ route('welcome') }}">Welcome</a>
